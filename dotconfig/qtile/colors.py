...
Tokyonight = [
    ["#1a1b26", "#1a1b26"], # color[0]
    ["#acb0d0", "#acb0d0"], # color[1]
    ["#32344a", "#32344a"], # color[2]
    ["#f7768e", "#f7768e"], # color[3]
    ["#9ece6a", "#9ece6a"], # color[4]
    ["#e0af68", "#e0af68"], # color[5]
    ["#7aa2f7", "#7aa2f7"], # color[6]
    ["#ad8ee6", "#ad8ee6"], # color[7]
    ["#0db9d7", "#0db9d7"], # color[8]
    ["#787c99", "#787c99"], # color[9]
    ["#444b6a", "#444b6a"], # color[10]
    ["#ff7a93", "#ff7a93"], # color[11]
    ["#b9f27c", "#b9f27c"], # color[12]
    ["#ff9e64", "#ff9e64"], # color[13]
    ["#7da6ff", "#7da6ff"], # color[14]
    ["#bb9af7", "#bb9af7"], # color[15]
    ["#449dab", "#449dab"], # color[16]
    ["#acb0d0", "#acb0d0"]  # color[17]
    ]
